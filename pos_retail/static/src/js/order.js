...
odoo.define('pos_retail.order', function (require) {
    ...
    models.Order = models.Order.extend({
        ...
        export_as_JSON: function () {
            ...
            if(this.pos_branch_id){
                json.pos_branch_id = this.pos_branch_id
            } else if (this.pos.config.pos_branch_id) {
        ...
        validate_payment_order: function () {
            console.log("inside validate payment order👍👍")
            var self = this;
            var client = this.get_client();
            if (this.pos.config.multi_lots) {
    ...
    models.Orderline = models.Orderline.extend({
        ...
        export_as_JSON: function () {
            ...
            if(this.order.pos_branch_id){
                json.pos_branch_id = this.order.pos_branch_id;
            } else if (this.pos.config.pos_branch_id) {
                json.pos_branch_id = this.pos.config.pos_branch_id[0]
            }
            return json;
